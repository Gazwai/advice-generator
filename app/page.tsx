...
export default function Home() {
  const { data, mutate, isValidating } = useGetRequest(
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="relative flex min-h-80 w-96 flex-col rounded-xl bg-slate-700 px-8 pb-20 pt-12 md:w-[32rem]">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="mb-8 flex min-h-40 w-4/5 flex-col justify-center text-center text-2xl font-medium">
            {isValidating ? (
              <svg
                aria-hidden="true"
                className="mx-auto h-20 w-20 animate-spin fill-blue-600 text-gray-200 dark:text-gray-600"
                viewBox="0 0 100 101"
                fill="none"
              ...
              <p className="mx-auto text-center text-2xl font-medium">
                {`"${advice}"`}
              </p>
            )}
          </div>
